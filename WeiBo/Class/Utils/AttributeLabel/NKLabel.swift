...
@objc public protocol NKLabelDelegate: NSObjectProtocol {
    /// 选中链接文本
    ///
    /// - parameter label: label
    /// - parameter text:  选中的文本
    @objc optional func labelDidSelectedLinkText(label: NKLabel, text: String)
}
...
public class NKLabel: UILabel {
    ...
    public weak var delegate: NKLabelDelegate?
